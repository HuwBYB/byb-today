      ...
      <div style={{ display: "grid", gap: 10 }}>
        ...
        <label>
          <div style={{ fontSize: 12, color: "#666", marginBottom: 4 }}>
            How will you know you’re halfway?
          </div>
          <input
            value={halfwayNote}
        ...
        <label>
          ...
          />
          <div style={{ fontSize: 12, color: "#666", marginTop: 6 }}>
            Starts next month on the same day-of-month.
          </div>
        </label>
        ...
        <label>
          ...
          />
          <div style={{ fontSize: 12, color: "#666", marginTop: 6 }}>
            Seeds every day from today (or future start) through target date.
          </div>
        </label>
